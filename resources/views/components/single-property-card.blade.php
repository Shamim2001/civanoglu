<div class="flex-1 mx-2 shadow-lg relative rounded-md mb-6">
    <a href="" class="absolute left-3 w-9 h-9 leading-10 self-center  top-3 bg-black text-white bg-opacity-25 text-center hover:bg-blue-500 hover:text-white duration-200 rounded-full text-base"><i class="fa fa-heart-o"></i></a>

    <div class="py-20 bg-center bg-no-repeat" style="background-image: url('/img/banner-2.jpg')"></div>

    <div class="p-3">
        <h3 class="leading-0 text-base">{{$property->name}}</h3>
        ...
        <a href="{{route('single-property', $property->id)}}" class="fullwidth-btn text-center">More details</a>
    </div>
</div>